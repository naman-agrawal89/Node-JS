...
router.get('/', serverFunctions.home);
router.get('/lastblocks', serverFunctions.getLastBlocksTX);
router.get('/decode', serverFunctions.decodeTx);
router.get('/lasttx', serverFunctions.getLastTx);
router.get('/getreserve', serverFunctions.getReserve);
